# Contributing to LlamaProxy

Thank you for your interest in contributing to LlamaProxy! This document provides guidelines and instructions for contributing to this project.
...
There are many ways to contribute to LlamaProxy:
...
2. **Clone your fork**:
   ```bash
   git clone https://github.com/YOUR_USERNAME/llamaproxy.git
   cd llamaproxy
   ```

3. **Set up the upstream remote**:
   ```bash
   git remote add upstream https://github.com/llamasearchai/llamaproxy.git
   ```
...
By contributing to LlamaProxy, you agree that your contributions will be licensed under the project's MIT License.
